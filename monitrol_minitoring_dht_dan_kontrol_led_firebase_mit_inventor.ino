...
#define FIREBASE_HOST "https://monitrol-dht-led-default-rtdb.firebaseio.com/"
#define FIREBASE_AUTH "9kXvV3wQfLAvGmDGQGKbeeJc06P5fHe0tAd8ZhKe"

//Nama Wifi
#define WIFI_SSID "DENAME"
...
void loop() {
  ...
  if (Firebase.getString(firebaseData, "/Data/ledValue")) {
    String ledValueStr = firebaseData.stringData();
    if (ledValueStr == "1") {
      digitalWrite(led, HIGH);
    } else if (ledValueStr == "0") {
